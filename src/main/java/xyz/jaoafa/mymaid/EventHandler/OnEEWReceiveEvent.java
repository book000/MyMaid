...
public class OnEEWReceiveEvent implements Listener {
	...
	public void onEEWReceiveEvent(EEWReceiveEvent e){
		...
		if(result.equalsIgnoreCase("null")){
			...
			String kairiku, keihou, DataType;
			if(data[3].equalsIgnoreCase("8") || data[3].equalsIgnoreCase("9")){
				DataType = "最終報";
			}else{
				DataType = "速報";
			}
			...
			Bukkit.broadcastMessage("[" + ChatColor.GOLD + "MyEEW" + ChatColor.RESET + "] " + ChatColor.RED + "------------ 地震速報 (" + DataType + ") ------------");
